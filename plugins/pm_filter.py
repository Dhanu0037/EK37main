...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, DELETE_TIME
...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("🤧 Hey Buddy This Rquest Not For You, \n\nRquest Your Own 😌", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("▫️ Pages", callback_data="pagees"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('▶️ YT ᴄʜᴀɴɴᴇʟ', url='https://youtube.com/c/editingking37'),
        ...
        buttons = [[
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', callback_data='shivapm'),
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        ...
        text="<b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ. ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ</b>", disable_web_page_preview=True,
        )        
        await asyncio.sleep(8)
        await t.delete()
        await msg.delete()
